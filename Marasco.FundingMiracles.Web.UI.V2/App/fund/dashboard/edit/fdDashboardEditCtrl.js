...
fundoloApp.controller('fdDashboardEditCtrl',['$modal', '$scope', '$stateParams', '$location', '$log', '$filter','fdDashboardSvc', 'mdCoreDataSvc', 'appUrl',
  function fdDashboardEditCtrl($modal, $scope, $stateParams, $location, $log, $filter, fdDashboardSvc, mdCoreDataSvc, appUrl) {
...
//#endregion /Initialize*/
    ...
    $scope.uploader = ({
      ...
      showFileList: false,
      async: {
        saveUrl: appUrl.api + '/api/uploader',
        removeUrl: appUrl.api + '/api/uploader',
        removeVerb: 'DELETE',
        autoUpload: true
      },
      localization: {
