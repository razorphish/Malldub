$(document).ready(function () {
    ...
    var grid = $("#grid").kendoGrid({
        ...
        detailInit: donationNoteDetails,
        pageable: true,
        filterable: true,
        sortable: true,
        navigatable: true,
    ...
    function donationNoteDetails(e) {
        $("<div/>").appendTo(e.detailCell).kendoGrid({
            dataSource:             {
                ...
                filter: { field: "Identification", operator: "eq", value: e.data.DonationId },
                serverFiltering: true,
                serverSorting: true,
                allowUnsort: true,
                serverPaging: true,
    ...
    $("#toolbarFilter").kendoDropDownList({
        ...
        change: function () {
            ...
            if (value) {
                grid.data("kendoGrid").dataSource.filter({ field: "DonationId", operator: "eq", value: value });
            } else {
