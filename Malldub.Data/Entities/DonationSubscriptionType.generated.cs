...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="DonationSubscriptionType")]
    [DataContractAttribute(IsReference=true)]
    [ScaffoldTable(true)]
    [Serializable()]
    public partial class DonationSubscriptionType : EntityObject
    {
        #region Factory Methods

        /// <summary>
        /// Create a new DonationSubscriptionType object.
        /// </summary>
        ...
        public static DonationSubscriptionType CreateDonationSubscriptionType(global::System.String identification, global::System.String friendlyName, global::System.String description)
        {
            DonationSubscriptionType donationSubscriptionType = new DonationSubscriptionType();
            donationSubscriptionType.Identification = identification;
            donationSubscriptionType.FriendlyName = friendlyName;
            donationSubscriptionType.Description = description;

            return donationSubscriptionType;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Donation_DonationType", "Donation")]
        public EntityCollection<Donation> DonationList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Donation>("Malldub.Data.FK_Donation_DonationType", "Donation");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Donation>("Malldub.Data.FK_Donation_DonationType", "Donation", value);
                }
            }
        }
