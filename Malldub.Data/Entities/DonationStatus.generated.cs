...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="DonationStatus")]
    [DataContractAttribute(IsReference=true)]
    [ScaffoldTable(true)]
    [Serializable()]
    public partial class DonationStatus : EntityObject
    {
        #region Factory Methods

        /// <summary>
        /// Create a new DonationStatus object.
        /// </summary>
        ...
        public static DonationStatus CreateDonationStatus(global::System.String identification, global::System.String friendlyName, global::System.String description)
        {
            DonationStatus donationStatus = new DonationStatus();
            donationStatus.Identification = identification;
            donationStatus.FriendlyName = friendlyName;
            donationStatus.Description = description;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Donation_DonationStatus", "Donation")]
        public EntityCollection<Donation> DonationList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Donation>("Malldub.Data.FK_Donation_DonationStatus", "Donation");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Donation>("Malldub.Data.FK_Donation_DonationStatus", "Donation", value);
                }
            }
        }
