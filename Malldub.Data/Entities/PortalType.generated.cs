...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="PortalType")]
    [DataContractAttribute(IsReference=true)]
    [ScaffoldTable(true)]
    [Serializable()]
    public partial class PortalType : EntityObject
    {
        #region Factory Methods

        /// <summary>
        /// Create a new PortalType object.
        /// </summary>
        ...
        public static PortalType CreatePortalType(global::System.String identification, global::System.String details, global::System.Byte sortOrderNumber)
        {
            PortalType portalType = new PortalType();
            portalType.Identification = identification;
            portalType.Details = details;
            portalType.SortOrderNumber = sortOrderNumber;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Portal_PortalType", "Portal")]
        public EntityCollection<Portal> PortalList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Portal>("Malldub.Data.FK_Portal_PortalType", "Portal");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Portal>("Malldub.Data.FK_Portal_PortalType", "Portal", value);
                }
            }
        }
