...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="FundShareType")]
    [DataContractAttribute(IsReference=true)]
    [ScaffoldTable(true)]
    [Serializable()]
    public partial class FundShareType : EntityObject
    {
        #region Factory Methods

        /// <summary>
        /// Create a new FundShareType object.
        /// </summary>
        ...
        public static FundShareType CreateFundShareType(global::System.String identification, global::System.String friendlyName)
        {
            FundShareType fundShareType = new FundShareType();
            fundShareType.Identification = identification;
            fundShareType.FriendlyName = friendlyName;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_FundShare_FundShareType", "FundShare")]
        public EntityCollection<FundShare> FundShareList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<FundShare>("Malldub.Data.FK_FundShare_FundShareType", "FundShare");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<FundShare>("Malldub.Data.FK_FundShare_FundShareType", "FundShare", value);
                }
            }
        }
