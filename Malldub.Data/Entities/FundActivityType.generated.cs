...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="FundActivityType")]
    [DataContractAttribute(IsReference=true)]
    [ScaffoldTable(true)]
    [Serializable()]
    public partial class FundActivityType : EntityObject
    {
        #region Factory Methods

        /// <summary>
        /// Create a new FundActivityType object.
        /// </summary>
        ...
        public static FundActivityType CreateFundActivityType(global::System.String identification, global::System.String friendlyName)
        {
            FundActivityType fundActivityType = new FundActivityType();
            fundActivityType.Identification = identification;
            fundActivityType.FriendlyName = friendlyName;

            return fundActivityType;
        }
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_FundActivity_FundActivityType", "FundActivity")]
        public EntityCollection<FundActivity> FundActivityList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<FundActivity>("Malldub.Data.FK_FundActivity_FundActivityType", "FundActivity");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<FundActivity>("Malldub.Data.FK_FundActivity_FundActivityType", "FundActivity", value);
                }
            }
        }
