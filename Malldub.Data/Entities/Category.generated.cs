...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="Category")]
    ...
    public partial class Category : EntityObject
    {
        ...
        public static Category CreateCategory(global::System.Int32 identification, global::System.String name)
        {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_ItemCategory_Category", "ItemCategory")]
        public EntityCollection<ItemCategory> ItemCategoryList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<ItemCategory>("Malldub.Data.FK_ItemCategory_Category", "ItemCategory");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<ItemCategory>("Malldub.Data.FK_ItemCategory_Category", "ItemCategory", value);
                }
            }
        }
