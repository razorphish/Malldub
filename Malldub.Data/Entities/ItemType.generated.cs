...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="ItemType")]
    ...
    public partial class ItemType : EntityObject
    {
        ...
        public static ItemType CreateItemType(global::System.String identification, global::System.String details, global::System.Byte sortOrderNumber)
        {
            ItemType itemType = new ItemType();
            itemType.Identification = identification;
            itemType.Details = details;
            itemType.SortOrderNumber = sortOrderNumber;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Item_ItemType", "Item")]
        public EntityCollection<Item> ItemList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Item>("Malldub.Data.FK_Item_ItemType", "Item");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Item>("Malldub.Data.FK_Item_ItemType", "Item", value);
                }
            }
        }
