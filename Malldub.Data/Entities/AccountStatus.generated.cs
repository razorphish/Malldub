...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="AccountStatus")]
    ...
    public partial class AccountStatus : EntityObject
    {
        ...
        public static AccountStatus CreateAccountStatus(global::System.String identification, global::System.String details, global::System.Byte sortOrderNumber)
        {
            AccountStatus accountStatus = new AccountStatus();
            accountStatus.Identification = identification;
            accountStatus.Details = details;
            accountStatus.SortOrderNumber = sortOrderNumber;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Account_AccountStatus", "Account")]
        public EntityCollection<Account> AccountList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Account>("Malldub.Data.FK_Account_AccountStatus", "Account");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Account>("Malldub.Data.FK_Account_AccountStatus", "Account", value);
                }
            }
        }
