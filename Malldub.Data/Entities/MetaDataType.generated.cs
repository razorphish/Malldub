...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="MetaDataType")]
    ...
    public partial class MetaDataType : EntityObject
    {
        ...
        public static MetaDataType CreateMetaDataType(global::System.String identification, global::System.String details, global::System.Byte sortOrderNumber)
        {
            MetaDataType metaDataType = new MetaDataType();
            metaDataType.Identification = identification;
            metaDataType.Details = details;
            metaDataType.SortOrderNumber = sortOrderNumber;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_MetaKey_MetaDataType", "MetaKey")]
        public EntityCollection<MetaKey> MetaKeyList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<MetaKey>("Malldub.Data.FK_MetaKey_MetaDataType", "MetaKey");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<MetaKey>("Malldub.Data.FK_MetaKey_MetaDataType", "MetaKey", value);
                }
            }
        }
