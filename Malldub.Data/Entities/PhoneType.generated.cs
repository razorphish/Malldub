...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="PhoneType")]
    ...
    public partial class PhoneType : EntityObject
    {
        ...
        public static PhoneType CreatePhoneType(global::System.String identification, global::System.String description, global::System.Byte sortOrderNumber)
        {
            PhoneType phoneType = new PhoneType();
            phoneType.Identification = identification;
            phoneType.Description = description;
            phoneType.SortOrderNumber = sortOrderNumber;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Phone_PhoneType", "Phone")]
        public EntityCollection<Phone> PhoneList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Phone>("Malldub.Data.FK_Phone_PhoneType", "Phone");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Phone>("Malldub.Data.FK_Phone_PhoneType", "Phone", value);
                }
            }
        }
