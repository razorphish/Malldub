...
{
    [EdmEntityTypeAttribute(NamespaceName="Malldub.Data", Name="UploadCategory")]
    [DataContractAttribute(IsReference=true)]
    [ScaffoldTable(true)]
    [Serializable()]
    public partial class UploadCategory : EntityObject
    {
        #region Factory Methods

        /// <summary>
        /// Create a new UploadCategory object.
        /// </summary>
        ...
        public static UploadCategory CreateUploadCategory(global::System.String identification, global::System.String details, global::System.Byte sortOrderNumber)
        {
            UploadCategory uploadCategory = new UploadCategory();
            uploadCategory.Identification = identification;
            uploadCategory.Details = details;
            uploadCategory.SortOrderNumber = sortOrderNumber;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("Malldub.Data", "FK_Upload_UploadCategory", "Upload")]
        public EntityCollection<Upload> UploadList
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Upload>("Malldub.Data.FK_Upload_UploadCategory", "Upload");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Upload>("Malldub.Data.FK_Upload_UploadCategory", "Upload", value);
                }
            }
        }
