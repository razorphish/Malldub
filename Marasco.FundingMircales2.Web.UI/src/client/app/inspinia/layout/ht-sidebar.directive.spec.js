...
describe('htSidebar directive: ', function () {
    ...
    var isResponsiveClass = 'responsive';
    var scope;

    beforeEach(module('mars.inspinia.layout'));
    ...
    //     describe('the responsive class', function () {
    //         it('is present all around', function () {
    ...
    function hasResponsiveClass(isTrue) {
        var hasClass = dropdownElement.hasClass(isResponsiveClass);
        expect(hasClass).equal(!!isTrue,
            'menu has the "responsive" class is ' + hasClass);
    }
