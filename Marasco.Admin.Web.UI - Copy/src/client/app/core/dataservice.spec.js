...
//   bard.verifyNoOutstandingHttpRequests();
  ...
  // it('should be registered2', function () {
  //   expect(dataservice).not.to.equal(null);
  //   expect(dataservice).not.to.equal(undefined);
  // });

  // describe('getCustomers function', function() {
  //     it('should exist', function() {
  //         expect(dataservice.getCustomers).not.to.equal(null);
  //         expect(dataservice.getCustomers).not.to.equal(undefined);
  //     });
