...
ace.settings = {
	...
	navbar_fixed : function(navbar, fix , save, chain) {
		...
		if (fix) {
		    ...
		    if (!ace.hasClass(navbar, 'navbar-fixed-top')) {
		        //if (!ace.hasClass(main_container, 'marginMainContainerTop')) {
		        //    ace.addClass(main_container, 'marginMainContainerTop');
		        //}
		    ...
		    //ace.removeClass(main_container, 'marginMainContainerTop');
	...
	sidebar_fixed : function(sidebar, fix , save, chain) {
		...
		var menubar = '#headerbar';
		var main_content = '#main-content';
		var settings_container = '#ace-settings-container';
		var headerbar = '#headerbar';
		var navigationBar = '#navigationBar';

		if (typeof main_content === 'string') main_content = document.querySelector(main_content);
		if (typeof headerbar === 'string') headerbar = document.querySelector(headerbar);
		if (typeof navigationBar === 'string') navigationBar = document.querySelector(navigationBar);
		if (typeof settings_container === 'string') settings_container = document.querySelector(settings_container);
		if (typeof sidebar === 'string') sidebar = document.querySelector(sidebar);
		if (typeof menubar === 'string') menubar = document.querySelector(menubar);
		...
		if(fix) {
			if( !ace.hasClass(sidebar , 'sidebar-fixed') )  {
			    ...
			    ace.addClass(menubar, 'sidebar-fixed');
			    //ace.removeClass(headerbar, 'sideBarNotFixed');
			    ace.addClass(settings_container, 'marginTop88');
			    ace.addClass(main_content, 'marginTop88');
			    ace.addClass(sidebar, 'marginTop88');
		    ...
		    ace.removeClass(menubar, 'sidebar-fixed');
		    //ace.addClass(headerbar, 'sideBarNotFixed');
		    ace.removeClass(settings_container, 'marginTop88');
		    ace.removeClass(main_content, 'marginTop88');
		    ace.removeClass(sidebar, 'marginTop88');
		    //ace.removeClass(headerbar, 'marginLeftNeg12');
			var toggler = document.getElementById('menu-toggler');
		...
		if (window.jQuery) jQuery(document).trigger('settings.ace', ['sidebar_fixed', fix, menubar]);
	},
	...
	main_container_fixed : function(main_container, inside , save) {
		...
		if (typeof sidemenubar === 'string') sidemenubar = document.querySelector(sidemenubar);
		var sidebar_collapse = '#sidebar-collapse';
		if (typeof sidebar_collapse === 'string') sidebar_collapse = document.querySelector(sidebar_collapse);
		var headerbar = '#headerbar';
		if (typeof headerbar === 'string') headerbar = document.querySelector(headerbar);
		...
		if(inside) {
		    if (!ace.hasClass(main_container, 'container')) {
		        ...
		        ace.addClass(main_content, 'marginLeft0');
		        ace.addClass(sidemenubar, 'menu-min');
		        ace.removeClass(sidemenubar, 'sidebar-scroll');
		        ace.addClass(sidemenubar, 'hide');
		        ace.removeClass(headerbar, 'sideBarNotFixed');
		        ace.addClass(headerbar, 'headerBarWidth');
		    }
		    ...
		    ace.removeClass(sidemenubar, 'menu-min');
		    ace.removeClass(main_content, 'marginLeft0');
		    ace.addClass(sidemenubar, 'sidebar-scroll');
		    ace.removeClass(sidemenubar, 'hide');
		    ace.addClass(headerbar, 'sideBarNotFixed');
		    ace.removeClass(headerbar, 'headerBarWidth');
